//===-- qlogo/stringblock.h - List of strings used in qlogo -------*- C++
//-*-===//
//
...
///
/// \file
/// This file contains the list of QString declarations or definitions,
/// depending on the "ck()" macro definition being applied.
///
//===----------------------------------------------------------------------===//
