...
//===-- qlogo/logointerfacegui.h - LogoInterfaceGUI class definition -------*- C++ -*-===//
//
...
///
/// \file
/// This file contains the declaration of the LogoInterfaceGUI class, which is
...
/// @brief  The LogoInterfaceGUI class is a subclass of the LogoInterface class.
...
class LogoInterfaceGUI : public LogoInterface
{
  ...
  public:
    /// @brief Constructor for the LogoInterfaceGUI class.
    /// @param parent The parent Qt object.
    LogoInterfaceGUI(QObject *parent = nullptr);
